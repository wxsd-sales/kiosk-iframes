<script>
	...
	import BoopAction from '/src/animation/BoopAction.svelte';
	import { browser } from '$app/environment';
	import QA from '/src/components/Q&A.svelte';
	import listItems from '/src/faq';
	import Metrics from '/src/components/Metrics.svelte';
	import innovation from '/src/assets/innovation.jpeg';
	import video from '/src/assets/GSA-SMALL.mp4';
	import image from '/src/assets/GSA.jpeg';
	import { page } from '$app/stores';
	import { monitorWeather, weather, city, temperature } from '/src/stores';
		...
		{#if URL === null}
			<div class="customFooter">
				<div
					...
					style="height: 16rem; margin-left: 4rem;"
				>
					<figure class="image">
				...
				<div class="contact">
					<div class="box is-translucent-black mb-0" style="margin-left: 4rem;">
						<Metrics title='GSA WIL 2nd Floor' token={token}/>
					</div>
				</div>
			</div>
		{/if}
